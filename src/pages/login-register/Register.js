...
const Register = () => {
  return (
    <div className="flex lg:flex-row flex-col-reverse justify-center items-center">
      <div className="w-1/2">
        <img className="w-3/4 h-3/4" src={register} alt="Login" />
      </div>
      <div className="w1/2">
        <div className="w- max-w-md p-8 space-y-3 rounded-xl text-gray-900 bg-white border-zinc-50 border-[3px]">
          ...
          <form className="space-y-6 ng-untouched ng-pristine ng-valid">
            <div className="space-y-1 text-sm">
              ...
              <input
                ...
                required
                placeholder="Name"
                className="w-full px-4 py-3 rounded-md border-gray-700 bg-gray-100 text-black focus:border-violet-400"
              />
            </div>
            <div className="space-y-1 text-sm">
            ...
            <button className="block w-full p-3 text-center rounded-sm text-gray-900 bg-orange-600">
              Register
            </button>
          </form>
